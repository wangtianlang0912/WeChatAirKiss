...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPasswordEditText.setText("12345671");
    }
        ...
        protected void onPreExecute() {
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    try {
                        DatagramSocket udpServerSocket = new DatagramSocket(null);
                        udpServerSocket.setReuseAddress(true);
                        udpServerSocket.bind(new InetSocketAddress(9999));
                        int replyByteCounter = 0;
                        DatagramPacket packet = new DatagramPacket(buffer, buffer.length);

                        udpServerSocket.setSoTimeout(50000);
                        while (true) {

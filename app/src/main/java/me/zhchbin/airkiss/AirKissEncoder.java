...
public class AirKissEncoder {
    ...
    public AirKissEncoder(String ssid, String password) {
        ...
        while (times-- > 0) {
            ...
            for (int i = 0; i < 15; ++i) {
                ...
                sequenceCode(ssid,password);
            }
        }
    }

    public void sequenceCode(String ssid,String password){
    ...
    public int CRC8(String stringData) {
    ...
    public void magicCode(String ssid, String password) {
    ...
    public void prefixCode(String password) {
